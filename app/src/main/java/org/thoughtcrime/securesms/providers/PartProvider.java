...
public class PartProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://network.noth.provider.securesms/part";
  ...
  static {
    ...
    uriMatcher.addURI("network.noth.provider.securesms", "part/*/#", SINGLE_ROW);
  }
