...
public class BlobProvider {
  ...
  public static final Uri        CONTENT_URI = Uri.parse("content://network.noth.provider.securesms/blob");
  public static final String     AUTHORITY   = "network.noth.provider.securesms";
